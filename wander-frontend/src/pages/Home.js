...
import shaunImg from '../assets/shaunsheep.jpg';
  ...
  return (
    <div className="home-container">
      ...
      <section className="places-section">
        ...
        <h3>Places to <span className="highlight">Visit</span></h3>
      ...
      <section className="fans-love-section">
        ...
        <h3>What our fans say <span className="highlight">about us</span></h3>
        <div className="testimonial-grid">
          <div className="testimonial-card">
            ...
            <div className="testimonial-user">
              <img src={catImg} alt="Ali" className="user-img" />
          ...
          <div className="testimonial-card">
            ...
            <div className="testimonial-user">
              <img src={ladyImg} alt="Ayesha" className="user-img" />
              <div className="user-info">
          ...
          <div className="testimonial-card">
            ...
            <div className="testimonial-user">
              <img src={shaunImg} alt="Ibrahim" className="user-img" />
              <div className="user-info">
