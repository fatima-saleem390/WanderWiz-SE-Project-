...
app.get('/api/tours/:id/historical-places/:place', async (req, res) => {
  ...
  try {
    ...
    res.json({
      ...
      image: place.image,
      address: place.location || 'No address available',
...
app.get('/api/tours/:id/restaurants/:restaurant', async (req, res) => {
  ...
  try {
    ...
    res.json({
      ...
      image: rest.image,
      address: rest.location || 'No address available',
      reviews: rest.reviews || 0,
      rating: rest.rating || 4.8,
      userReviews: rest.userReviews || []
    });
  } catch (error) {
...
app.get('/api/tours/:id/hotels/:hotel', async (req, res) => {
  ...
  try {
    ...
    res.json({
      ...
      image: hotel.image,
      address: hotel.location || 'No address available',
